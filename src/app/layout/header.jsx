    ...
    <div className="pt-6 bg-black">
      ...
      <div className="navbar bg-white text-black">
        <div className="navbar-start">
          ...
          <Link href="/dashboard">
            <button className="btn btn-ghost text-xl mr-4">Exclusive</button>
          </Link>
        </div>
        ...
        <div className="navbar-end">
          <div className="form-control">
            <input type="text" placeholder="Search" className="input input-bordered bg-gray-200 w-24 md:w-auto" />
          </div>
